...
| Projeto                          | Descrição                           |
|----------------------------------|-------------------------------------|
| [Streamlit-Docling](link-do-repo) | Conversor de PDF para Markdown/OCR  |
| [FastChat-Vue](link-do-repo)     | Chatbot com FastAPI + Vue + Pinia   |
| [4u-commerce-api](link-do-repo)  | API de e-commerce completa          |
| [Lista-de-tarefas-em-Vue.js](link-do-repo) | App de tarefas com Electron e Vue |
